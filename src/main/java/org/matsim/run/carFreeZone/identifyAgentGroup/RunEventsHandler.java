...
public class RunEventsHandler {
    public static void main(String args[]) throws IOException {
        ...
        String outputFile_nonAffectedAgentIDsList = "scenarios/berlin-v5.5-1pct/input/carFreeZone/PlanA/IDLists/nonAffectedAgentIDsList.txt";
        ...
        eventHandler.printResults(outputFile_personInternalLinkIDsList, outputFile_workerIDsList, outputFile_agentsDoingEducationIDsList, outputFile_agentsDoingOtherActivitiesIDsList, outputFile_agentsWithoutActivitiesIDsList, outputFile_nonAffectedAgentIDsList);
