package org.matsim.run.carFreeZone.Plan2;
 ...
 * @author dziemke
 */
public class NetworkModifier_Plan2 {
    private static final Logger LOG = Logger.getLogger(NetworkModifier_Plan2.class);
    ...
    public static void main (String[] args) throws IOException {
        ...
        String networkOutputFile = "scenarios/berlin-v5.5-1pct/input/carFreeZone/PlanA/network-modified-carInternal_Plan2.xml.gz";
