package org.matsim.run.carFreeZone.Plan1;
 ...
 * @author dziemke
 */
public class NetworkModifier_Plan1 {
    private static final Logger LOG = Logger.getLogger(NetworkModifier_Plan1.class);
    ...
    public static void main (String[] args) throws IOException {
        ...
        String networkOutputFile = "scenarios/berlin-v5.5-1pct/input/carFreeZone/PlanA/network-modified-carInternal_Plan1.xml.gz";
...
/*        //******changes in PlanA_Version1_1******
        ...
        notCarModeList.addAll(GreenStreetsList); //musst have
        notCarModeList.addAll(ElongationPedestrianZoneList); //no impact
        //******changes in PlanA_Version1_1_fixed******
...
/*        //******changes in PlanA_Version1_1******
        ...
        for(String linkID : notCarModeList){
            scenario.getNetwork().getLinks().get(Id.createLinkId(linkID)).setAllowedModes(allowedModes);
        }
