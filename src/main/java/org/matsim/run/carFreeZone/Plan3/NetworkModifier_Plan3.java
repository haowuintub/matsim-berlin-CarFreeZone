package org.matsim.run.carFreeZone.Plan3;
 ...
 * @author dziemke
 */
public class NetworkModifier_Plan3 {
    private static final Logger LOG = Logger.getLogger(NetworkModifier_Plan3.class);
    ...
    public static void main (String[] args) throws IOException {
        ...
        String networkOutputFile = "scenarios/berlin-v5.5-1pct/input/carFreeZone/PlanA/network-modified-carInternal_Plan3.xml.gz";
