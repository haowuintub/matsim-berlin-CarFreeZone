...
public final class RunBerlinScenario_PlanA {

	private static final Logger log = Logger.getLogger(RunBerlinScenario_PlanA.class );
	...
	public static Controler prepareControler( Scenario scenario ) {
		...
		controler.addOverridingModule( new AbstractModule(){
			...
			public void install(){
				...
				this.addPlanStrategyBinding( "SubtourModeChoiceInternal" ).toProvider( new Provider<PlanStrategy>(){
					@Inject
