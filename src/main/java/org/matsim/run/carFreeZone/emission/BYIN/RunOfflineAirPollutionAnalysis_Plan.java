...
* @author ikaddoura
*/
//BYIN: The network is for berlin region, not for Berlin city. It is better to use this to calculate the overall events emission, then cut the areas (boundingbox or berlin city) for aggregation.
public class RunOfflineAirPollutionAnalysis_Plan {
...
//	final static String runDirectory = "output-berlin-v5.5-1pct-policyCase1_200/";
	...
	final static String runDirectory = "output-berlin-v5.5-1pct-policyCase3_200/";  // BYIN: the second case with passing roads in the paper.
...
//		String rootDirectory = null;
		...
		//VehicleUtils.setHbefaVehicleCategory( freightEngineInformation, HbefaVehicleCategory.LIGHT_COMMERCIAL_VEHICLE.toString());
