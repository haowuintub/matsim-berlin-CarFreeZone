...
//BYIN: when using boundingbox and berlin city:  the emissions seem not correct. It is better to use the original network for event emission calculation.

public class RunOfflineAirPollutionAnalysis_basedCase_BoundingBox {
	//BoundingBox:
...
/*	private static final double xMin = 4583462.7365;
	...
	// --- for basedCase ---
	final static String runDirectory = "output-berlin-v5.5-1pct-baseCase_200/";
...
//		String rootDirectory = null;
		...
		//		config.transit().setVehiclesFile(rootDirectory + runDirectory + runId + ".output_transitVehicles.xml.gz"); //BYIN: we don't consider transit vehicle for emissions: comment this and below setting will address nan issue of aggregation by grid.
...
//			if(link.getId().toString().equals("135706")){
